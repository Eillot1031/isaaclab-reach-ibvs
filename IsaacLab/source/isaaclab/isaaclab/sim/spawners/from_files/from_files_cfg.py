...
_LOCAL_GROUND_USD = "/home/krz/isaaclab_ws/assets/environments/grid/default_environment.usd"
_GROUND_USD_PATH = (
    _LOCAL_GROUND_USD
    if os.path.isfile(_LOCAL_GROUND_USD)
    else f"{ISAAC_NUCLEUS_DIR}/Environments/Grid/default_environment.usd"
)
