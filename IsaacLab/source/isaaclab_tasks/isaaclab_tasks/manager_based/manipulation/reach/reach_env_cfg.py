...
# Always use Nucleus table — local stubs under assets/props lack Materials/Textures.
_TABLE_USD_PATH = f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/SeattleLabTable/table_instanceable.usd"
